...
try {
    ...
    if (
        ...
        $sollicitud->data_preferent = isset($data->data_preferent) ? $data->data_preferent : null;
        $sollicitud->nombre_alumnes = $data->nombre_alumnes;
        $sollicitud->comentaris = isset($data->comentaris) ? $data->comentaris : '';
        ...
        echo json_encode(array(
            "message" => "Falten dades obligatòries (centre_id, taller_id, nombre_alumnes).",
            "success" => false,
            "received" => array(
                "centre_id" => isset($data->centre_id) ? $data->centre_id : null,
                "taller_id" => isset($data->taller_id) ? $data->taller_id : null,
                "nombre_alumnes" => isset($data->nombre_alumnes) ? $data->nombre_alumnes : null
            )
        ));
    }
} catch (Exception $e) {
